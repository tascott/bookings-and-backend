...
export default function VehicleManagement({ vehicles, staff, isLoading, error, onAdd, onDelete }: VehicleManagementProps) {
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
          {vehicles.map(vehicle => (
            <li key={vehicle.id} style={{ border: '1px solid #eee', padding: '0.8rem', marginBottom: '0.5rem', borderRadius: '4px' }}>
              ...
              Staff: {staff.find(s => s.id === vehicle.staff_id)?.name || 'Unknown'}<br />
